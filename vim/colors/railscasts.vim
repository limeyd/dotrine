...
hi CursorLine                guibg=#333346
hi LineNr                    guifg=#888888 guibg=#333333
hi Search                    guibg=#ffaa00
hi Visual                    guibg=#5A647E
hi WildMenu guifg=Black   guibg=#ffff00 gui=bold ctermfg=Black ctermbg=Yellow cterm=bold
"call s:hibg("MatchParen","#1100AA","DarkBlue",18)
" Borders
hi StatusLine    guifg=Black   guibg=#999999 gui=none ctermfg=Black ctermbg=White  cterm=none
hi StatusLineNC  guifg=#999999 guibg=#555555 gui=none ctermfg=Black ctermbg=Grey   cterm=none
hi VertSplit guibg=black guifg=grey45
hi GitLine  guifg=#eeeeee guibg=#4183C4 gui=bold ctermfg=White ctermbg=Blue cterm=bold
